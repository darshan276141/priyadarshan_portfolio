        ...
        <section
            ...
            <div className="text-center z-10 px-4">
                ...
                <p className="tex-gray-400 text-lg mb-8 max-w-lg mx-auto">
                    As a passionate MERN stack developer, I specialize in creating dynamic, scalable, and user-centric web applications. With expertise in MongoDB, Express.js, React, and Node.js, I build end-to-end solutions that drive seamless user experiences.
                </p>
